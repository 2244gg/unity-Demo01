...
public class AssetBundleManager : Singleton<AssetBundleManager>
{
    ...
    public bool LoadAssetBundleConfig()
    {
        ...
        var path = Path.Combine(Application.streamingAssetsPath, m_ABConfigABName);
        //AssetBundle configAB = AssetBundle.LoadFromFile(configPath);
        AssetBundle configAB = AssetBundle.LoadFromFile(path);
       // AssetBundle configAB1 = AssetBundle.LoadFromFile(configPath);
    ...
    private AssetBundle LoadAssetBundle(string name)
    {
        ...
        if (!m_AssetBundleItemDic.TryGetValue(crc, out item))
        {
            ...
            var fullPath = Path.Combine(ABLoadPath, name);
